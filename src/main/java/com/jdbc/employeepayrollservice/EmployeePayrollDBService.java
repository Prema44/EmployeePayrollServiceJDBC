...
public class EmployeePayrollDBService {
	...
	private int updateEmployeeDataUsingStatement(String name, double salary) throws DatabaseException, SQLException {
		int employeeId = -1;
		int rowAffected = 0;
		Connection connection = null;
	 ...
	 * @throws DatabaseException 
	 */
	private void addToPayrollDetails(Connection connection, int employeeId, double salary) throws DatabaseException {
		try (Statement statement = (Statement) connection.createStatement()) { 
